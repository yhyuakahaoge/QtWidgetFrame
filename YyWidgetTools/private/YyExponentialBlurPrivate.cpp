...
#include <cmath>
#endif
int YyExponentialBlurPrivate::_aprec = 12;
int YyExponentialBlurPrivate::_zprec = 7;
YyExponentialBlurPrivate::YyExponentialBlurPrivate(QObject* parent)
    : QObject{parent}
{
}

YyExponentialBlurPrivate::~YyExponentialBlurPrivate()
{
}

void YyExponentialBlurPrivate::_drawExponentialBlur(QImage& image, const quint16& qRadius)
{
    if (qRadius < 1)
    {
        return;
...
void YyExponentialBlurPrivate::_drawRowBlur(QImage& image, const int& row, const int& alpha)
{
    int zR, zG, zB, zA;
...
void YyExponentialBlurPrivate::_drawColumnBlur(QImage& image, const int& column, const int& alpha)
{
    int zR, zG, zB, zA;
...
void YyExponentialBlurPrivate::_drawInnerBlur(unsigned char* bptr, int& zR, int& zG, int& zB, int& zA, int alpha)
{
    int R, G, B, A;
    R = *bptr;
    G = *(bptr + 1);
