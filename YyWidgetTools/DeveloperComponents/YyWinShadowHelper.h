#ifndef YyWINSHADOWHELPER_H
#define YyWINSHADOWHELPER_H
#include "YyDef.h"
...
#define eWinHelper YyWinShadowHelper::getInstance()
class YyWinShadowHelper : public QObject
{
    Q_OBJECT
    Q_PRIVATE_CREATE(bool, IsWinVersionGreater10)
    Q_PRIVATE_CREATE(bool, IsWinVersionGreater11)
    Q_SINGLETON_CREATE(YyWinShadowHelper)
private:
    explicit YyWinShadowHelper(QObject* parent = nullptr);
    ~YyWinShadowHelper() override;
...
public:
    ...
    void setWindowDisplayMode(QWidget* widget, YyApplicationType::WindowDisplayMode displayMode, YyApplicationType::WindowDisplayMode lastDisplayMode);
